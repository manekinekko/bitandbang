...
const data = {
  ...
  work: chalk.white('Developer Advocate at Microsoft'),
  opensource1: chalk.white('Angular core team '),
  opensource2: chalk.white('Compodoc core team '),
  opensource3: chalk.white('xlayers.dev Author '),
  opensource4: chalk.white('autocap.cc Author '),
  ...
  web: chalk.cyan('https://wassim.dev'),
